                  ...
                  <TableRow key={coupon._id}>
                    <TableCell>
                      <div>
                        ...
                        <div className="text-sm text-muted-foreground line-clamp-1">{coupon.couponDescription}</div>
                      </div>
                    </TableCell>
                    <TableCell>
                      <div className="flex items-center gap-2">
                        {coupon.storeId?.logoImage && (
                          <img
                            src={coupon.storeId.logoImage || "/placeholder.svg"}
                            alt=""
                            className="w-6 h-6 rounded object-cover"
                          />
                        )}
                        <span className="text-sm">{coupon.storeId?.storeName}</span>
                      </div>
                    </TableCell>
                    <TableCell>
                      <div className="flex items-center gap-2">
                    ...
                    <TableCell>
                      <Badge variant="outline">
                        {coupon.codeType === "percentage" && "% Off"}
                        {coupon.codeType === "fixed" && "$ Off"}
                    ...
                    <TableCell>
                      <div className="flex gap-2">
                        <Button size="sm" variant="ghost" asChild>
                          <a href={coupon.trackingLink} target="_blank" rel="noopener noreferrer">
